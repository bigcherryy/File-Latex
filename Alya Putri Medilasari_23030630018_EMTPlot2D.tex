...
Euler dapat memplot plot 2D dari - ekspresi - fungsi, variabel, atau kurva parameter, - vektor nilai x-y, - awan titik di pesawat, - kurva implisit dengan level atau wilayah level. - Fungsi kompleks
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-001.png}} \textgreater plot2d(``sin(x)'',-2*pi,2*pi): // plot sin(x) pada interval {[}-2pi, 2pi{]}

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-002.png}} \textgreater plot2d(``cos(x)'',``sin(3*x)'',xmin=0,xmax=2pi):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-003.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-003.png}
\end{figure}
...
\textgreater reset; \textgreater figure(2,2); \ldots{}\\
\textgreater{} for n=1 to 4; figure(n); plot2d(``x\^{}''+n); end; \ldots{}\\
\textgreater{} figure(0):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-004.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-004.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-005.png}} Jika argumen ke plot2d() adalah ekspresi yang diikuti oleh empat angka, angka-angka ini adalah rentang x dan y untuk plot.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-006.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-006.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-007.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-007.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-008.png}} \textgreater plot2d(``x\^{}x'',r=1.2,cx=1,cy=1):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-009.png}} Perhatikan bahwa x\^{}x tidak didefinisikan untuk x\textless=0. Fungsi plot2d menangkap kesalahan ini, dan mulai merencanakan segera setelah fungsi didefinisikan. Ini berfungsi untuk semua fungsi yang mengembalikan NAN keluar dari jangkauan definisinya.

\textgreater plot2d(``log(x)'',-0.1,2):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-010.png}} Parameter square=true (atau \textgreater square) memilih y-range secara otomatis sehingga hasilnya adalah jendela plot persegi. Perhatikan bahwa secara default, Euler menggunakan ruang persegi di dalam jendela plot.

\textgreater plot2d(``x\^{}3-x'',\textgreater square):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-011.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-011.png}
\end{figure}

\textgreater plot2d(`'integrate(``sin(x)*exp(-x\^{}2)'',0,x)'\,',0,2): // plot integral

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-012.png}} Jika Anda membutuhkan lebih banyak ruang untuk label-y, panggil shrinkwindow() dengan parameter yang lebih kecil, atau tetapkan nilai positif untuk ``lebih kecil'' di plot2d().

\textgreater plot2d(``gamma(x)'',1,10,yl=``y-values'',smaller=6,\textless vertical):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-013.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-013.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-014.png}} \textgreater a:=5.6; expr \&= exp(-a*x\^{}2)/a; // define expression \textgreater plot2d(expr,-2,2): // plot from -2 to 2

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-015.png}} \textgreater plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-016.png}} \textgreater plot2d(\&diff(expr,x),\textgreater add,style=``--'',color=red): // add another plot

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-017.png}} \textgreater plot2d(\&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-018.png}} \textgreater plot2d(\&diff(expr,x),a=-2,b=2,\textgreater square): // keep plot square \pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-019.png}} \textgreater plot2d(``x\^{}2'',0,1,steps=1,color=red,n=10):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-020.png}} \textgreater plot2d(``x\^{}2'',\textgreater add,steps=2,color=blue,n=10):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-021.png}} \# Fungsi dalam satu Parameter
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-022.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-022.png}
\end{figure}

\textgreater plot2d(``f'',0,1;0.4): // plot with a=0.4

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-023.png}} \textgreater plot2d(\{\{``f'',0.2\}\},0,1): // plot with a=0.2

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-024.png}} \textgreater plot2d(\{\{``f(x,b)'',b=0.1\}\},0,1): // plot with 0.1

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-025.png}} \textgreater function f(x) := x\^{}3-x; \ldots{}\\
\textgreater{} plot2d(``f'',r=1):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-026.png}} Berikut adalah ringkasan dari fungsi yang diterima * ekspresi atau ekspresi simbolik dalam x * fungsi atau fungsi simbolis dengan nama sebagai ``f'' * fungsi simbolis hanya dengan nama
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-027.png}} Tentu saja, untuk ekspresi atau ekspresi simbolik, nama variabel sudah cukup untuk memplotnya.
...
\textgreater plot2d(expr,0,3pi): \pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-028.png}} \textgreater function f(x) \&= x\^{}x;

\textgreater plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);

\textgreater plot2d(\&diff(f(x),x),\textgreater add,color=red,style=``-.-''):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-029.png}} Untuk gaya garis ada berbagai pilihan. * gaya=``\ldots{}''. Pilih dari ``-'', ``--'', ``-.'', ``.'', ``.-.'', ``-.-''. * warna: Lihat di bawah untuk warna. * ketebalan: Default adalah 1.

Warna dapat dipilih sebagai salah satu warna default, atau sebagai warna RGB. * 0.15: indeks warna default. * konstanta warna: putih, hitam, merah, hijau, biru, cyan, zaitun, * abu-abu muda, abu-abu, abu-abu tua, oranye, hijau muda, pirus, biru * muda, oranye terang, kuning * rgb(merah, hijau, biru): parameter adalah real dalam {[}0,1{]}.

\textgreater plot2d(``exp(-x\^{}2)'',r=2,color=red,thickness=3,style=``--''):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-030.png}} Berikut adalah tampilan warna EMT yang telah ditentukan sebelumnya.

\textgreater aspect(2); columnsplot(ones(1,16),lab=0:15,grid=0,color=0:15):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-031.png}} Tapi Anda bisa menggunakan warna apa saja.

\textgreater columnsplot(ones(1,16),grid=0,color=rgb(0,0,linspace(0,1,15))):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-032.png}} \# Menggambar Beberapa Kurva pada bidang koordinat yang sama
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-033.png}} \textgreater aspect(1.5); plot2d(``sin(x)'',0,2pi); plot2d(``cos(x)'',color=blue,style=``--'',\textgreater add):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-034.png}} Salah satu kegunaan \textgreater add adalah untuk menambahkan titik pada kurva.

\textgreater plot2d(``sin(x)'',0,pi); plot2d(2,sin(2),\textgreater points,\textgreater add):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-035.png}} Kami menambahkan titik persimpangan dengan label (pada posisi ``cl'' untuk kiri tengah), dan memasukkan hasilnya ke dalam notebook. Kami juga menambahkan judul ke plot.

\textgreater plot2d({[}``cos(x)'',``x''{]},r=1.1,cx=0.5,cy=0.5, \ldots{}\\
\textgreater{} color={[}black,blue{]},style={[}``-'',``.''{]}, \ldots{}\\
\textgreater{} grid=1); \textgreater x0=solve(``cos(x)-x'',1); \ldots{}\\
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-036.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-036.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-038.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-038.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-039.png}} Metode kedua menggunakan pasangan matriks nilai-x dan matriks nilai-y yang berukuran sama.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-040.png}} Perhatikan bahwa parameter warna dapat berupa vektor. Kemudian setiap warna digunakan untuk setiap baris matriks.

\textgreater x=linspace(0,1,200); y=x\^{}(1:10)'; plot2d(x,y,color=1:10):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-041.png}} Metode lain adalah menggunakan vektor ekspresi (string). Anda kemudian dapat menggunakan larik warna, larik gaya, dan larik ketebalan dengan panjang yang sama.

\textgreater plot2d({[}``sin(x)'',``cos(x)''{]},0,2pi,color=4:5):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-042.png}} \textgreater plot2d({[}``sin(x)'',``cos(x)''{]},0,2pi): // plot vector of expressions

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-043.png}} Kita bisa mendapatkan vektor seperti itu dari Maxima menggunakan makelist() dan mxm2str().
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-044.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-044.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-045.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-045.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-046.png}} Atau, gunakan koleksi dengan nama fungsi dan semua parameter tambahan. Daftar khusus ini disebut koleksi panggilan, dan itu adalah cara yang lebih disukai untuk meneruskan argumen ke fungsi yang dengan sendirinya diteruskan sebagai argumen ke fungsi lain.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-047.png}} Kami dapat mencapai hasil yang sama dengan cara berikut menggunakan bahasa matriks EMT. Setiap baris matriks f(x,a) adalah satu fungsi. Selain itu, kita dapat mengatur warna untuk setiap baris matriks. Klik dua kali pada fungsi getspectral() untuk penjelasannya.

\textgreater x=-10:0.01:10; a=(1:10)'; plot2d(x,f(x,a),color=getspectral(a/10)):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-048.png}} \#\# Label Teks

Dekorasi sederhana bisa * judul dengan judul=``\ldots{}'' * x- dan y-label dengan xl=``\ldots{}'', yl=``\ldots{}'' * label teks lain dengan label(``\ldots{}'',x,y)
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-049.png}} \textgreater expr := ``log(x)/x''; \ldots{}\\
\textgreater{} plot2d(expr,0.5,5,title=``y=''+expr,xl=``x'',yl=``y''); \ldots{}\\
\textgreater{} label(``(1,0)'',1,0); label(``Max'',E,expr(E),pos=``lc''):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-050.png}} Ada juga fungsi labelbox(), yang dapat menampilkan fungsi dan teks. Dibutuhkan vektor string dan warna, satu item untuk setiap fungsi.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-051.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-051.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-052.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-052.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-053.png}} Fitur serupa adalah fungsi textbox().
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-054.png}} Label teks, judul, kotak label, dan teks lainnya dapat berisi string Unicode (lihat sintaks EMT untuk mengetahui lebih lanjut tentang string Unicode).

\textgreater plot2d(``x\^{}3-x'',title=u''x → x³ - x''):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-055.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-055.png}
\end{figure}

Label pada sumbu x dan y bisa vertikal, begitu juga sumbunya. \textgreater plot2d(``sinc(x)'',0,2pi,xl=``x'',yl=u''x → sinc(x)``,\textgreater vertical):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-056.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-056.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-057.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-057.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-058.png}} Tentu saja, fungsi juga dapat digunakan. \textgreater function map f(x) \ldots{}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-059.png}} \#\# Interaksi pengguna

Saat memplot fungsi atau ekspresi, parameter \textgreater user memungkinkan pengguna untuk memperbesar dan menggeser plot dengan tombol kursor atau mouse. Pengguna dapat * perbesar dengan + atau - * pindahkan plot dengan tombol kursor * pilih jendela plot dengan mouse * atur ulang tampilan dengan spasi * keluar dengan kembali

Tombol spasi akan mengatur ulang plot ke jendela plot asli. Saat memplot data, flag \textgreater user hanya akan menunggu penekanan tombol.

\textgreater plot2d(\{\{``x\^{}3-a*x'',a=1\}\},\textgreater user,title=``Press any key!''):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-060.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-060.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-061.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-061.png}
\end{figure}
...
Perhatikan parameter titik koma di plot2d (d dan xp), yang diteruskan ke evaluasi fungsi interp(). Tanpa ini, kita harus menulis fungsi plotinterp() terlebih dahulu, mengakses nilai secara global. Sekarang kita menghasilkan beberapa nilai acak, dan membiarkan pengguna menyeret poin.

\textgreater t=-1:0.5:1; dragpoints(``plotf'',t,random(size(t))-0.5):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-062.png}} Ada juga fungsi, yang memplot fungsi lain tergantung pada vektor parameter, dan memungkinkan pengguna menyesuaikan parameter ini.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-063.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-063.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-064.png}} Berikut ini adalah demonstrasi sederhana dari fungsi tersebut. Pengguna dapat menggambar di atas jendela plot, meninggalkan jejak poin.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-065.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-065.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-066.png}} Untuk judul plot dan label sumbu, lihat contoh berikut.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-067.png}} Sumbu dapat digambar secara terpisah dengan xaxis() dan yaxis().
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-068.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-068.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-069.png}} Ada juga kotak teks.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-070.png}} \textgreater plot2d({[}``exp(x)'',``1+x''{]},color={[}black,blue{]},style={[}``-'',``-.-''{]}):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-071.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-071.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-072.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-072.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-073.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-073.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-074.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-074.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-075.png}} Data juga dapat diplot sebagai titik. Gunakan poin=true untuk ini. Plotnya bekerja seperti poligon, tetapi hanya menggambar sudut-sudutnya. * style=``\ldots{}'': Pilih dari ``{[}{]}'', ``\textless\textgreater{}'', ``o'', ``.'', ``..'', ``+'', ``\emph{'', ''{[}{]}\#'', }''\textless{} \textgreater\#``,''o\#``,''..\#``,''\#``,''\textbar``.

Untuk memplot set poin gunakan \textgreater points. Jika warna adalah vektor warna, setiap titik mendapat warna yang berbeda. Untuk matriks koordinat dan vektor kolom, warna berlaku untuk baris matriks.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-076.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-076.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-077.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-077.png}
\end{figure}

\chapter{Menggambar Daerah Yang Dibatasi Kurva}\label{menggambar-daerah-yang-dibatasi-kurva}

Plot data benar-benar poligon. Kita juga dapat memplot kurva atau kurva terisi. * terisi=benar mengisi plot. * style=``\ldots{}'': Pilih dari ``\#'', ``/'', ``",''/``. * fillcolor: Lihat di atas untuk warna yang tersedia.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-078.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-078.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-079.png}} \textgreater t=linspace(0,2pi,6); \ldots{}\\
\textgreater{} plot2d(cos(t),sin(t),\textgreater filled,style=``/'',fillcolor=red,r=1.2):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-080.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-080.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-081.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-081.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-082.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-082.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-083.png}} Poin utama dari bahasa matriks adalah memungkinkan untuk menghasilkan tabel fungsi dengan mudah.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-084.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-084.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-085.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-085.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-086.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-086.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-087.png}} Kami juga dapat mengisi rentang nilai seperti

\textgreater plot2d(``(x\textsuperscript{2+y}2)\textsuperscript{2-x}2+y\^{}2'',r=1.2,level={[}-1;0{]},style=``/''):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-088.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-088.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-089.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-089.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-090.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-090.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-091.png}} \textgreater t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);

\textgreater plot2d(x,y,r=1):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-092.png}} Dalam contoh berikutnya, kami memplot kurva dengan
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-093.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-093.png}
\end{figure}
...
Matriks bilangan kompleks akan secara otomatis diplot sebagai kisi di bidang kompleks. Dalam contoh berikut, kami memplot gambar lingkaran satuan di bawah fungsi eksponensial. Parameter cgrid menyembunyikan beberapa kurva grid.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-094.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-094.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-095.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-095.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-096.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-096.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-097.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-097.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-098.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-098.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-099.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-099.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-100.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-100.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-101.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-101.png}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-102.png}} \textgreater plot2d(k,bin(10,k)); plot2d(k,bin(10,k),\textgreater points,\textgreater add):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-103.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-103.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-104.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-104.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-105.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-105.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-106.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-106.png}
\end{figure}

Untuk memplot distribusi statistik eksperimental, Anda dapat menggunakan distribution=n dengan plot2d. \textgreater w=randexponential(1,1000); // exponential distribution

\textgreater plot2d(w,\textgreater distribution): // or distribution=n with n intervals

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-107.png}} Atau Anda dapat menghitung distribusi dari data dan memplot hasilnya dengan \textgreater bar di plot3d, atau dengan plot kolom.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-108.png}} Fungsi statplot() menyetel gaya dengan string sederhana.

\textgreater statplot(1:10,cumsum(random(10)),``b''):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-109.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-109.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-110.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-110.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-111.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-111.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-112.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-112.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-113.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-113.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-114.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-114.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-115.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-115.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-116.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-116.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-117.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-117.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-118.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-118.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-119.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-119.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-120.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-120.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-121.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-121.png}
\end{figure}

\textgreater expr := ``2*x\textsuperscript{2+x*y+3*y}4+y''; // define an expression f(x,y) \textgreater plot2d(expr,level=0): // Solutions of f(x,y)=0

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-122.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-122.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-123.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-123.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-124.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-124.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-125.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-125.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-126.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-126.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-127.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-127.png}
\end{figure}

\textgreater z=z+normal(size(z))*0.2; \textgreater plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-128.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-128.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-129.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-129.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-130.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-130.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-131.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-131.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-132.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-132.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-133.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-133.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-134.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-134.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-135.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-135.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-136.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-136.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-137.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-137.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-138.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-138.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-139.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-139.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-140.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-140.png}
\end{figure}
...
Plot logaritma dapat diplot baik menggunakan skala logaritma dalam y dengan logplot=1, atau menggunakan skala logaritma dalam x dan y dengan logplot=2, atau dalam x dengan logplot=3. * logplot=1: y-logaritma * logplot=2: x-y-logaritma * logplot=3: x-logaritma

\textgreater plot2d(``exp(x\textsuperscript{3-x)*x}2'',1,5,logplot=1):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-141.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-141.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-142.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-142.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-143.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-143.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-144.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-144.png}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-145.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-145.png}
\end{figure}

Ini juga berfungsi dengan plot data. \textgreater x=10\^{}(1:20); y=x\^{}2-x; \textgreater plot2d(x,y,logplot=2):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-146.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-146.png}
\end{figure}

\chapter{Rujukan Lengkap Fungsi plot2d() function plot2d (xv, yv, btest, a,}\label{rujukan-lengkap-fungsi-plot2d-function-plot2d-xv-yv-btest-a}
...
\textgreater a:=4; expr \&=exp(a*(x\^{}2)/a); \textgreater plot2d(expr,-1,1,grid=3,thickness=3):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-147.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-147.png}
\end{figure}
...
\textgreater a=5; expr \&=(x\^{}2-a*x); \textgreater plot2d(expr,1,2):

\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-148.png}} 3. Selidi dimanakah fungsi f(x) berikut naik dan turun

\textgreater expr \&= ((1/3)*x\textsuperscript{3-x}2-3*x+4); \textgreater plot2d(expr,-4,5):

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/Alya Putri Medilasari_23030630018_EMTPlot2D-149.png}}
\caption{images/Alya\%20Putri\%20Medilasari\_23030630018\_EMTPlot2D-149.png}
\end{figure}
